...
{
    /// <summary>
    /// 定向脉冲环粒子（移植自灾厄的 DirectionalPulseRing）：弑神者冲刺的起手冲击环与中段脉冲环。
    /// 空心圆环贴图按 Squish 压扁并朝向 Rotation，随寿命按 PolyOut(4) 缓动由 OriginalScale 放大到 FinalScale，
    /// 同时透明度按 sin 曲线衰减。
    /// </summary>
    public class DirectionalPulseRing : Particle
    {
        ...
        /// <summary>贴图使用 Assets/Particles/HollowCircleHardEdge</summary>
        public override string Texture => "CalamityDemutation/Assets/Particles/HollowCircleHardEdge";
        ...
        // ── 构造函数 ──
        /// <summary>
        /// 构造脉冲环：记录位置、速度、基准色、压扁系数、朝向与缩放起止值，初始缩放取 originalScale。
        /// </summary>
