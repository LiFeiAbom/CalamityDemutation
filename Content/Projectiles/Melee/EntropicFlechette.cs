...
{
    /// <summary>
    /// 熵之飞刃（中号）—— 熵之舞挥砍时撒出的扇形飞刀之一（照搬灾厄 2.0.3.9 的 <c>EntropicFlechette</c>）。
    /// 朝速度方向摆正自身，飞行途中绕剑身喷两股反向旋转的暗影焰尘，并朝 200 像素内最近的敌人追踪。
    /// 三档飞刃（小 8×8 / 中 12×12 / 大 18×18）除碰撞箱外代码完全一致，伤害倍率由熵之舞本体按档位决定。
    /// </summary>
    internal class EntropicFlechette : ModProjectile
    {
        ...
        /// <summary>基础属性：12×12 碰撞箱、友方近战、穿透 1、存活 600 帧</summary>
