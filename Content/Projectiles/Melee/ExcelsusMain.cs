...
{
    /// <summary>
    /// 宙宇波能刃的主刃弹幕（移植自灾厄 2.0.3.9 ExcelsusMain）：
    /// 左键三弹幕中的主刀，旋转前进、撞墙后限时收缩，命中施加弑神炼狱（找不到退回诅咒狱火）。
    /// </summary>
    internal class ExcelsusMain : ModProjectile
    {
        ...
        /// <summary>速度低于 20 时加速、寿命最后 85 帧减速，旋转随速度，随机喷蓝/粉尘土</summary>
        public override void AI()
        {
            ...
            if (Main.rand.NextBool(8))
                Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, Main.rand.NextBool(3) ? DustID.BlueFairy : DustID.PinkTorch, Projectile.velocity.X * 0.5f, Projectile.velocity.Y * 0.5f);
        }
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Main.EntitySpriteDraw(ModContent.Request<Texture2D>("CalamityDemutation/Content/Projectiles/Melee/ExcelsusMainGlow").Value, Projectile.Center - Main.screenPosition, null, color, Projectile.rotation, origin, Projectile.scale, SpriteEffects.None, 0);
        }
