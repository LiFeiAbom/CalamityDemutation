...
{
    /// <summary>
    /// 宙宇波能刃的粉刃弹幕（移植自灾厄 2.0.3.9 ExcelsusPink）：
    /// 左键三弹幕中的粉刀，与主刃同构，仅速度阈值（24）与尘土色（粉）不同，命中施加弑神炼狱。
    /// </summary>
    internal class ExcelsusPink : ModProjectile
    {
        ...
        /// <summary>速度低于 24 时加速、寿命最后 85 帧减速，旋转随速度，随机喷粉尘土</summary>
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Main.EntitySpriteDraw(ModContent.Request<Texture2D>("CalamityDemutation/Content/Projectiles/Melee/ExcelsusPinkGlow").Value, Projectile.Center - Main.screenPosition, null, color, Projectile.rotation, origin, Projectile.scale, SpriteEffects.None, 0);
        }
