...
{
    /// <summary>
    /// 熵之飞刃（小号）—— 熵之舞挥砍时撒出的扇形飞刀之一（照搬灾厄 2.0.3.9 的 <c>EntropicFlechetteSmall</c>）。
    /// 与中号飞刃代码逐行相同，只有碰撞箱缩小到 8×8（伤害倍率 0.3，见 <see cref="EntropicClaymore"/>）。
    /// </summary>
    internal class EntropicFlechetteSmall : ModProjectile
    {
        ...
        /// <summary>基础属性：8×8 碰撞箱、友方近战、穿透 1、存活 600 帧</summary>
