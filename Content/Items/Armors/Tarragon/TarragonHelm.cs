    ...
    internal class TarragonHelm:ModItem
    {
        ...
        public override void AddRecipes()
        {
            if (ModLoader.TryGetMod("CalamityMod", out Mod calamity))
            {
                ...
                recipe.AddIngredient(calamity.Find<ModItem>("UelibloomBar").Type, 12);
                recipe.AddIngredient(calamity.Find<ModItem>("DivineGeode").Type, 6);
            ...
            if (ModLoader.TryGetMod("CalamityModClassicPreTrailer", out Mod calamity1))
            {
                ...
                recipe1.AddIngredient(calamity1.Find<ModItem>("UeliaceBar").Type, 7);
                recipe1.AddIngredient(calamity1.Find<ModItem>("DivineGeode").Type, 6);
