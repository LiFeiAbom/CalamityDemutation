    ...
    internal class OmegaBlueHelmet:ModItem
    {
        ...
        public override void AddRecipes()
        {
            if (ModLoader.TryGetMod("CalamityMod", out Mod calamity))
            {
                ...
                recipe.AddIngredient(calamity.Find<ModItem>("ReaperTooth").Type, 3);
                recipe.AddIngredient(calamity.Find<ModItem>("DepthCells").Type, 15);
                recipe.AddIngredient(calamity.Find<ModItem>("RuinousSoul").Type);
            ...
            if (ModLoader.TryGetMod("CalamityModClassicPreTrailer", out Mod calamity1))
            {
                ...
                recipe1.AddIngredient(calamity1.Find<ModItem>("ReaperTooth").Type, 11);
                recipe1.AddIngredient(calamity1.Find<ModItem>("Lumenite").Type, 5);
