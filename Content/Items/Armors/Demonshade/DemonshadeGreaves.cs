...
namespace CalamityDemutation.Content.Items.Armors.Demonshade
{
    ...
    internal class DemonshadeGreaves:ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.value = Item.buyPrice(3, 0, 0, 0);  // 售价 3 铂金
            Item.defense = 57; //15
        ...
        public override void AddRecipes()
        {
            if (ModLoader.TryGetMod("CalamityMod", out Mod calamity))
            {
                ...
                recipe.AddIngredient(calamity.Find<ModItem>("ShadowspecBar").Type, 45);  // 现代版灾厄：ShadowspecBar×45
            ...
            if (ModLoader.TryGetMod("CalamityModClassicPreTrailer", out Mod calamity1))
            {
                ...
                recipe1.AddIngredient(calamity1.Find<ModItem>("ShadowspecBar").Type, 45);  // 经典版灾厄：ShadowspecBar×45
