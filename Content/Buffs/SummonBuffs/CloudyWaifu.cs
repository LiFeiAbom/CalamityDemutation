...
{
    /// <summary>
    /// 云元素召唤增益：CloudyWaifu 召唤物在场时保持此增益
    /// </summary>
    internal class CloudyWaifu:ModBuff
    {
        /// <summary>
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            // 云元素（CloudyWaifu）在场时置位标记
            if (player.ownedProjectileCounts[ModContent.ProjectileType<Projectiles.Summon.CloudyWaifu>()] > 0)
            {
