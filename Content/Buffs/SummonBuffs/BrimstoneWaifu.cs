...
{
    /// <summary>
    /// 硫火元素召唤增益：BigBustyRose 召唤物在场时保持此增益
    /// </summary>
    internal class BrimstoneWaifu:ModBuff
    {
        /// <summary>
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            // 硫火元素（BigBustyRose）在场时置位标记
            if (player.ownedProjectileCounts[ModContent.ProjectileType<BigBustyRose>()] > 0)
            {
