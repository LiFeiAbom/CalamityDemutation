...
{
    /// <summary>
    /// 沙元素召唤增益：SandyWaifu 召唤物在场时保持此增益
    /// </summary>
    internal class SandyWaifu:ModBuff
    {
        /// <summary>
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            // 沙元素（SandyWaifu）在场时置位标记
            if (player.ownedProjectileCounts[ModContent.ProjectileType<Projectiles.Summon.SandyWaifu>()] > 0)
            {
                modPlayer.sandyWaifu= true;
            }
