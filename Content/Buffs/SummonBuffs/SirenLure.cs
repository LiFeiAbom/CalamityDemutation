...
{
    /// <summary>
    /// 塞壬之饵召唤增益：SirenLure 召唤物在场时保持此增益
    /// </summary>
    internal class SirenLure:ModBuff
    {
        /// <summary>
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            // 塞壬（SirenLure）在场时置位标记
            if (player.ownedProjectileCounts[ModContent.ProjectileType<Projectiles.Summon.SirenLure>()] > 0)
            {
                modPlayer.sirenLureWaifu = true;
            }
